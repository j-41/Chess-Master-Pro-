// SVG Chess Pieces - All 12 pieces (6 per color)
// High-quality vector pieces inspired by standard chess piece designs
...
export const WhiteKing: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
...
export const WhiteQueen: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
...
export const WhiteRook: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
    <g fill="#fff" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 39h27v-3H9v3zM12 36v-4h21v4H12zM11 14V9h4v2h5V9h5v2h5V9h4v5" strokeLinecap="butt"/>
      <path d="M34 14l-3 3H14l-3-3"/>
      <path d="M15 17v7.5H30V17" strokeLinecap="butt" strokeLinejoin="miter"/>
      <path d="M14 29.5v4h17v-4" strokeLinecap="butt" strokeLinejoin="miter"/>
      <path d="M14 25.5H31M14 29.5H31" fill="none" strokeLinejoin="miter"/>
      <path d="M14 게임 25.5v4h17v-4" fill="none" strokeLinecap="butt" strokeLinejoin="miter" stroke="none"/>
    </g>
  </svg>
);

export const WhiteBishop: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const WhiteKnight: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const WhitePawn: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
...
export const BlackKing: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M11.5 29.5c5.5-3 15.5-3 21 0M11.5 33.5c5.5-3 15.5-3 21 0M11.5 37c5.5-3 15.5-3 21 0" stroke="#fff"/>
    </g>
  </svg>
);

export const BlackQueen: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
...
export const BlackRook: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
...
export const BlackBishop: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M22.5 15.5v-3M20 18h5" stroke="#fff" strokeLinejoin="miter"/>
    </g>
  </svg>
);

export const BlackKnight: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const BlackPawn: React.FC<PieceProps> = ({ size = 45, style, className }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} style={style} className={className}>
...
// ============ PIECE MAP ============
export const PieceComponents: Record<string, React.FC<PieceProps>> = {
  'wk': WhiteKing,
  'wq': WhiteQueen,
  'wr': WhiteRook,
  'wb': WhiteBishop,
...
export const getPieceComponent = (color: 'w' | 'b', type: string): React.FC<PieceProps> | null => {
  ...
  return PieceComponents[key] || null;
};
